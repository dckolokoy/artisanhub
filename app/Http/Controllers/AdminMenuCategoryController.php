...
class AdminMenuCategoryController extends Controller
{
    ...
    {
        $menu_categories  = DB::table('categories')->orderBy('id', 'desc')->get();
        return view('pages\admin\menu_category\index',compact("menu_categories"));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/category')->with('success','New category successfully added!');
    }
