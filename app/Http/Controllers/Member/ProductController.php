...
class ProductController extends \App\Http\Controllers\Controller
{
    ...
    public function index()
    {
        ...
        return view('pages\member\product\index',compact("menu_items","categories","product_count"));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasfile('image')) {
            ...
            $filenameInTable = 'justnpot/images/menu/' . $filename;
        ...
        return redirect('/member/product')->with('success','Product item successfully added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasfile('image2')){
            ...
            $filename = $user1.'menu-item-image'.time().'.'.$extension1;
            $file1->move('uploads/menu_item/', $filename);
            $menu_item->image = $filename;
        }

        $menu_item->save();

        return redirect('/admin/menu-item')->with('success','Product item successfully updated!');
    }
