...
class AdminTransactionScheduledController extends Controller
{
    ...
    public function index()
    {
        ...
        ->where('transactions.order_type','=','1')
        ->orderBy('t_id', 'desc')
        ->paginate(10);


        return view('pages\admin\transaction\scheduled',compact("transactions"));
    }
