...
class AdminTransactionReservationController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('transactions.id as t_id',
                 ...
                 'reservations.reservation_date as r_reservation_date',
                 'users.name as u_name')
        ->join('users','users.id','=','transactions.user_id')
        ->join('reservations','reservations.transaction_id','=','transactions.id')
        ->where('transactions.order_type','=','2')
        ->orderBy('t_id', 'desc')
        ->paginate(10);


        return view('pages\admin\transaction\reservation',compact("transactions"));
    }
