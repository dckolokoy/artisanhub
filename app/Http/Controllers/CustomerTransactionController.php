...
class CustomerTransactionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('justnpot/customer/transactions',compact("transactions"));
    }
    ...
    public function show($id)
    {
        ...
        return view('s',compact("materials"));
    }
    ...
    public function updateOrder(Request $request, $id)
    {
        ...
        return redirect('/transactions')->with('success','Transaction status successfully updated!');
