...
@section('content')
    ...
    <div style="background-color: #2E556A">
        <div class="container p-3">
            <div class="row">
                <div class="col-sm-3">
                    <img src="/images/CLSU/logo-white.png" class="rounded float-left img-thumbnail header-logo img-fluid"
                ...
                <div class="col-sm-3">
                    <img src="/images/CLSU/E-LearningLogo.png" class="rounded float-right img-thumbnail header-logo img-fluid"
    ...
    <div class="bg-light pt-4">
        <div class="container">
            <div class="card mb-12 bg-light" style="border: 0px;">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <img src="/images/CLSU/University.png" class="img-fluid rounded-start p-0" alt="..." style="box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 12px;">
