                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a id="member-chat-link" href="{{ route('member-chat', ['store_id' => auth()->user()->id, 'customer_id' => $user->id]) }}" class="btn btn-info text-white mt-2" data-id="{{ $user->id }}">
...
$(document).ready(function() {
    $('body').on('click', '#member-chat-link', function(event) {
        ...
        $.ajax({
            url: '{{ route('chat.mark-as-read-member') }}',
            type: 'POST',
            data: {
