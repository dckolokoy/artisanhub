                ...
                <table class="table table-head-fixed text-nowrap table-striped table-hover" id="myTable" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">{{$transaction ->u_name}} <a ><i class="fas fa-eye fa-sm" style="cursor: pointer;" id="btnInfo" data-id="{{$transaction ->u_id }}"></i></a></td>
                  ...
                  <td class="align-middle">
                          ...
                          @if($transaction ->t_status == 0)
                            <form action="/member/transaction/order/{{$transaction ->t_id }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                                @csrf
                                @method('PUT')
