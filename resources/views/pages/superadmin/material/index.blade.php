...
<nav class="main-header  navbar-expand navbar-white navbar-light " style="padding: 5px !important;z-index: 1">
  <!-- Left navbar links -->
     <div class="row mx-0">
          ...
          <div class="col-sm-5">
            <h4 style="font-weight: bold" class="mt-1">Materials</h4>
          </div>
                       ...
                       <div class="modal-dialog modal-lg " role="document">
                         <div class="modal-content">
                           ...
                           <div class="modal-body">
                             <form action="/admin/material" method="POST" enctype="multipart/form-data">
                               @csrf
                               ...
                               <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-select js-example-basic-multiple" aria-label="Default select example" name="sel_category" id="sel_category" >
                ...
                <table class="table table-head-fixed text-nowrap table-striped table-hover" id="myTable" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">{{$material ->m_id }}</td>
                      <td class="align-middle">{{$material ->m_title}}</td>
                      ...
                      <!-- <td class="align-middle text-wrap text" >{{$material ->m_desc}}</td> -->
                      <td class="align-middle">{{$material ->c_code}}</td>
                      <td class="align-middle">{{$material ->m_price}}</td>
                      <td class="align-middle">{{$material ->m_enrolled}}</td>
                      <td class="align-middle">{{$material ->m_rem}}</td>
                      <td class="align-middle">
                        @if($material ->m_status == 0)
                            Active
                        @elseif($material ->m_status == 1)
                            Inactive
                        @endif
                      </td>
                      <td class="align-middle">
