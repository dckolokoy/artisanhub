...
<nav class="main-header  navbar-expand navbar-white navbar-light " style="padding: 5px !important;z-index: 1">
                       ...
                       <div class="modal-dialog modal-lg " role="document">
                         <div class="modal-content">
                           ...
                           <div class="modal-body">
                             <form action="/member/product" method="POST" enctype="multipart/form-data" id="product-form">
                               @csrf
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-select js-example-basic-multiple" aria-label="Default select example" name="sel_category_id" id="sel_category_id"  required>
                                            ...
                                            @foreach($categories as $category)
                                              <option name="{{$category->type}}" value="{{$category->id}}"> {{$category->name}} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-sm-6">
  ...
  <div class="col-sm-6">
    ...
    <input type="file" name="image2" id="image2" placeholder="Image 2">
  </div>
  <div class="col-sm-6">
    <label for="image3">Back view</label>
    <input type="file"  name="image3" id="image3" placeholder="Image 3"
  </div>
</div>
</fieldset>
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" name="artist" id="artist" value="{{ auth()->user()->name }}"  required readonly>
                                    </div>
                ...
                <table class="table table-head-fixed text-nowrap table-striped table-hover" id="myTable" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle"><img src="{{ asset($menu_item->m_image) }}" style="height:80px;width:120px;" class="card-img-top" alt="..."></td>
                      <td class="align-middle">{{$menu_item ->m_name}}</td>
                      <td class="align-middle  text-wrap">{{$menu_item ->m_description}}</td>
                      <td class="align-middle">{{$menu_item ->m_artist}}</td>
                      ...
                      <td class="align-middle">
                          {{-- update modal --}}
                          <button type="button" data-id="{{ $menu_item->m_id }}"  class="btn btn-primary editbtn"> <i class="fas fa-edit"></i> </button>
                          <form action="/admin/product/{{ $menu_item->m_id }}" method="POST" style=" display:inline;">
                            @csrf
                            @method("DELETE")
                              ...
                              <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" name="artist2" id="artist2" placeholder="Artist" required>
                                    </div>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
  ...
  $(document).ready(function () {
    ...
    $('#sel_category_id').change(function() {
      var categoryType = $(this).find('option:selected').attr('name');
    ...
    $('body').on('click', '.editbtn', function () {
      ...
      $('#editmodal').modal('show');
         ...
         let updateroutes = "/admin/product/"+id;
