                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                          {{-- update modal --}}
                          <button type="button" data-id="{{ $menu_category->id }}"  class="btn btn-primary editbtn"> <i class="fas fa-edit"></i> </button>
                          <form action="/admin/category/{{ $menu_category->id }}" method="POST" style=" display:inline;">
                            @csrf
                            @method("DELETE")
