              ...
              <div class=" card-body table-responsive p-0" style="z-index: -99999">
                <table class="table table-head-fixed text-nowrap table-striped table-hover" id="myTable" >
                  ...
                  <tr>
                    ...
                    <td class="align-middle">
                        @if ( $payment->payment_type == 0 )
                            {{   date('M-d-Y', strtotime("+1 months",strtotime($payment->created_at))) }}

                        @elseif ( $payment->payment_type == 1)
                        {{   date('M-d-Y', strtotime("+3 months",strtotime($payment->created_at))) }}
                        @else
                        {{   date('M-d-Y', strtotime("+12 months",strtotime($payment->created_at))) }}
                        @endif
                    </td>
                    <td class="align-middle">
                        @if ( $payment->payment_type == 0 )

                            @if ( date('M-d-Y') != date('M-d-Y', strtotime("+1 months",strtotime($payment->created_at))))
                                Active
                            @else
                                Ended
                            @endif
                        ...
                        @elseif ( $payment->payment_type == 1)
                            ...
                            @if (date('M-d-Y')!= date('M-d-Y', strtotime("+3 months",strtotime($payment->created_at))))
                              Active
                            @else
                              Ended
                            @endif
                        @else
                            ...
                            @if (date('M-d-Y')!=  date('M-d-Y', strtotime("+12 months",strtotime($payment->created_at))) )
                                Active
                            @else
                                 Ended
                            @endif
