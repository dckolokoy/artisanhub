...
<nav class="main-header  navbar-expand navbar-white navbar-light " style="padding: 5px !important;z-index: 1">
  <!-- Left navbar links -->
     <div class="row mx-0">
          ...
          <div class="col-sm-5">
            <h4 style="font-weight: bold" class="mt-1">Scheduled Order Transactions</h4>
          </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">{{$transaction ->u_name}}</td>
                        @if($transaction ->t_payment_type == 0)
                      ...
                      <td class="align-middle">
                        <button data-id="{{$transaction ->t_id }}" type="button" class="btn btn-primary printBtn"> <i class="fas fa-clipboard-list"></i>View Orders</button>
                      </td>
                      ...
                      <td class="align-middle">
                          ...
                          <form action="/admin/transaction/order/{{$transaction ->t_id }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                              ...
                              <input type="text" style="display: none;" value="scheduled" name="route" id="route">
                          ...
                          <form action="/admin/transaction/order/{{$transaction ->t_id }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                           ...
                           @elseif($transaction ->t_status == 1)
                              <form action="/admin/transaction/order/{{$transaction ->t_id }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                                  ...
                                  <input type="text" style="display: none;" value="scheduled" name="route" id="route">
                                  <button type="submit"  class="btn  btn-primary" style="display:inline;"><i class="fas fa-utensils"> </i></button>
                              </form>
                          ...
                          <form action="/admin/transaction/order/{{$transaction ->t_id }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                              ...
                              <input type="text" style="display: none;" value="scheduled" name="route" id="route">
                              <button type="submit"  class="btn  btn-primary" style="display:inline;"><i class="fa fa-check"> </i></button>
                          </form>
                          ...
                          <form action="/admin/transaction/order/{{$transaction ->t_id }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                              ...
                              <input type="text" style="display: none;" value="scheduled" name="route" id="route">
                              <button type="submit"  class="btn  btn-primary" style="display:inline;"><i class="fas fa-motorcycle"> </i></button>
                          </form>
                          @elseif($transaction ->t_status == 4)
                              ...
                              <form action="/admin/transaction/order/{{$transaction ->t_id }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                                  ...
                                  <input type="text" style="display: none;" value="scheduled" name="route" id="route">
                                  <button type="submit"  class="btn  btn-success" style="display:inline;"><i class="fa fa-check"> </i></button>
                              </form>
                          ...
                          <form action="/admin/transaction/order/{{$transaction ->t_id }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                              ...
                              <button type="button"  class="btn  btn-success" style="display:inline;"><i class="fa fa-check"> </i></button>
