                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                          {{-- update modal --}}
                          <button type="button" data-id="{{ $user->id }}" class="btn btn-primary editbtn"> <i class="fas fa-edit"></i> </button>
                     ...
                     <button type="button" class="btn btn btn-danger" onclick="confirmDelete('{{ route('admins.destroy', $user->id) }}')" 
                     color: inherit;
                          border: none;
                          padding: 0;
                          font: inherit;
