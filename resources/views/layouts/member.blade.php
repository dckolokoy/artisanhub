  ...
  <aside style="background-color:#A7C7E7" class="main-sidebar  sidebar-light-success  elevation-1" style="max-height: calc(100vh - 9rem);
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-4 pb-2 mb-3 d-flex">
        <div class="image">
        <img src="{{ asset('uploads/image_id/' . auth()->user()->picture) }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
    ...
    <!-- categories -->
            ...
            <!-- Materials -->
            {{-- <li class="nav-item ">
                <a href="/member/category" class="nav-link ">
      ...
      <!-- Materials -->
            ...
            <!-- categories -->
            {{-- <li class="nav-item ">
                <a href="/member/chat" class="nav-link ">
            ...
            <!-- categories -->
            <div id="side-menu">
                @include('pages.admin.notification.alert')
            </div>
