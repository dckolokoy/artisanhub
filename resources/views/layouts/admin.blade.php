...
<div class="wrapper">
  ...
  <aside style="background-color:#A7C7E7"class="main-sidebar sidebar-light-success elevation-1" style="max-height: calc(100vh - 9rem);
    ...
    <!-- Brand Logo -->
      ...
      <center>
          <img src="{{ asset('/justnpot/images/menu/main4.png')}}" alt="JNP"  style ="height:100px; width:100px;">
      </center>
    ...
    <!-- categories -->
            ...
            <!-- Materials -->
             ...
             <!-- customer -->
             <li class="nav-item {{ (Illuminate\Support\Facades\Route::currentRouteName() == 'pending.index' || Illuminate\Support\Facades\Route::currentRouteName() == 'completed.index'|| Illuminate\Support\Facades\Route::currentRouteName() == 'approved.index' || Illuminate\Support\Facades\Route::currentRouteName() == 'declined.index'  ? 'menu-open' : '') }}" >
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item ">
                      <a href="/admin/user/pending" class="nav-link {{ (Illuminate\Support\Facades\Route::currentRouteName() == 'pending.index' ? 'active' : '') }}">
                        <i class="fas fa-user-edit nav-icon"></i>
                        <p style="{{ (Illuminate\Support\Facades\Route::currentRouteName() == 'pending.index' ? 'color:black' : '') }}; color:black">Pending</p>
                        <?php
                    ...
                    <li class="nav-item">
                      <a href="/admin/user/approved" class="nav-link {{ (Illuminate\Support\Facades\Route::currentRouteName() == 'approved.index' ? 'active' : '') }}">
                        <i class="fas fa-user-edit nav-icon"></i>
                        <p style="{{ (Illuminate\Support\Facades\Route::currentRouteName() == 'approved.index' ? 'color:black' : '') }};color:black ">Approved</p>
                        <?php
                        $con = new mysqli('localhost','root','','art');
                        $query = $con->query("
                    ...
                    <li class="nav-item">
                        <a href="/admin/user/declined" class="nav-link {{ (Illuminate\Support\Facades\Route::currentRouteName() == 'declined.index' ? 'active' : '') }}">
                        <i class="fas fa-user-edit nav-icon"></i>
                        <p style="{{ (Illuminate\Support\Facades\Route::currentRouteName() == 'declined.index' ? 'color:black' : '') }}; color:black">Declined</p>
                        <?php
                        $con = new mysqli('localhost','root','','art');
                        $query = $con->query("
