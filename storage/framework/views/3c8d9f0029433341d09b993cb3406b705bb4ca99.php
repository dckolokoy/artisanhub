...
if ($itemExist ->isNotEmpty()) {
    ...
    $purchased = false;
                ...
                ?>
                        ...
                        ?>
                                <div id="ez<?php echo e($menu2->m_id); ?>" class="carousel slide" data-ride="carousel">
...
<?php endif; ?>
                                ...
                                $total_likes1 = $like_count ?? 0;
                                                        ...
                                                        ?>
                                                        <?php if($liked == 1): ?>
                                                            <a class="btn  text-white unlikeBtn" data-id="<?php echo e($menu2->m_id); ?>" style="background-color: red" href="shop-single.html">
                                                                <i class="far fa-heart"><span style="font-size: 15px !important;"><?php echo e($total_likes1); ?></span></i>
                                                            </a>
                                                        <?php else: ?>
                                                            <a class="btn  btn-success text-white likeBtn"  data-id="<?php echo e($menu2->m_id); ?>" href="shop-single.html">
                                                                <i class="far fa-heart"><span style="font-size: 15px !important;"><?php echo e($total_likes1); ?></span></i>
                                                            </a>
                                                        <?php endif; ?>
                                                <?php else: ?>
                                    ...
                                    ?>
                                            ...
                                            <li><a class="btn btn-success text-white mt-2" href="/single/<?php echo e($menu2->m_id); ?>"><i class="far fa-eye"></i></a>
                                            ...
                                            <li>
                                               ...
                                               ->get();
                                                ...
                                                <?php if(Auth::check()): ?>
                                                        ...
                                                        <a  data-id="<?php echo e($menu2->m_id); ?>" data-user="<?php echo e($owned); ?>" class="btn btn-success text-white mt-2 editbtn"><i class="fas fa-cart-plus"></i></a><br>
                                            
                                                    <?php else: ?>
                                                        <a  data-id="<?php echo e($menu2->m_id); ?>" data-user="<?php echo e($owned); ?>" class="btn btn-success text-white mt-2 editbtn"><i class="fas fa-cart-plus"></i></a><br>
                                                    <?php endif; ?>
                                                      <a  href="<?php echo e(route('chat', ['material_id' => $menu2->m_id, 'store_id' => $menu2->s_id])); ?>"  class="btn btn-success text-white mt-2 "><i class="far fa-comment-dots"></i></a>
...
<?php endif; ?>     <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-left justify-content-left">
  ...
  <a class="carousel-control-prev" href="#ez<?php echo e($menu2->m_id); ?>" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" href="#ez<?php echo e($menu2->m_id); ?>" role="button" data-slide="next">
    <span class="carousel-control-next-icon" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>  
<?php elseif($menu2->type!="tangible"): ?>
...
<?php echo $__env->make('justnpot.customer-main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\artisanhub\resources\views/justnpot/customer/index.blade.php ENDPATH**/ ?>