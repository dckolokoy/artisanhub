              ...
              <div class=" card-body table-responsive p-0" style="z-index: -99999">
                <table class="table table-head-fixed text-nowrap table-striped table-hover" id="myTable" >
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        ...
                        <?php elseif($transaction ->t_status == 2): ?>
                            ...
                            Received by Customer/Wait for the payment <br> to be sent by Admin
                            <?php elseif($transaction ->t_status == 5): ?>
                            Payment sent by admin
                            <br> to your email
                  ...
                  <td class="align-middle">
                          ...
                          <?php if($transaction ->t_status == 0): ?>
                            <form action="/member/transaction/order/<?php echo e($transaction ->t_id); ?>" method="POST" enctype="multipart/form-data" style="display: inline;">
                                <?php echo csrf_field(); ?>
                                ...
                                <input type="text" style="display: none;" value="member" name="route2" id="route2">
                                ...
                                <button type="submit" id="Approve-form"  class="btn  btn-primary" style="display:inline;"><i class="fa fa-thumbs-up"> </i></button>
                            </form>
                            <form action="/member/transaction/order/<?php echo e($transaction ->t_id); ?>" method="POST" enctype="multipart/form-data" style="display: inline;">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                ...
                                <input type="text" style="display: none;" value="0" name="order_type" id="order_type">
                                <input type="text" style="display: none;" value="<?php echo e($transaction ->u_mobile); ?>" name="mobile" id="mobile">
                                <button type="submit" id="Declined-form"   class="btn  btn-danger" style="display:inline;"><i class="fa fa-thumbs-down"> </i></button>
                            </form>
                             ...
                             <?php elseif($transaction ->t_status == 5): ?>
                                <form action="/member/transaction/order/<?php echo e($transaction ->t_id); ?>" method="POST" enctype="multipart/form-data" style="display: inline;">
                                    ...
                                    <input type="text" style="display: none;" value="0" name="order_type" id="order_type">
                                    <input type="text" style="display: none;" value="<?php echo e($transaction ->u_mobile); ?>" name="mobile" id="mobile">
                                    <button type="submit" id="payment-form"  class="btn  btn-primary" style="display:inline;"><i class="fa fa-thumbs-up"> </i></button>
                                </form>
                                <?php elseif($transaction ->t_status == 1): ?>
                                <form action="/member/transaction/order/<?php echo e($transaction ->t_id); ?>" method="POST" enctype="multipart/form-data" style="display: inline;">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <label>Artworks Sent?: </label>
                                    <input type="text" style="display: none;" value="8" name="status" id="status">
                                    <input type="text" style="display: none;" value="order" name="route" id="route">
                                    <input type="text" style="display: none;" value="member" name="route2" id="route2">
                                    <input type="text" style="display: none;" value="0" name="order_type" id="order_type">
                                    <input type="text" style="display: none;" value="<?php echo e($transaction ->u_mobile); ?>" name="mobile" id="mobile">
                                    <button type="submit" id="Artwork-form"  class="btn  btn-primary" style="display:inline;"><i class="fa fa-thumbs-up"> </i></button>
                                </form>
...
<script>
  $(document).ready(function () {
    ...
    $('body').on('click', '.printBtn', function () {
        ...
        //   $("#printpres").attr("href", "/member/appointment/print-prescription/"+trans_id)
      $('#presModal').modal('show');
            $.ajax({
                  type: "GET",
                  url: "/member/transaction/get-order-list/"+trans_id,
                  dataType: "json",
    ...
    $('body').on('click', '.declinedBtn', function () {
      $('#declinedModal').modal('show');
       var trans_id = $(this).data('id');
         ...
         let declineroutes = "/member/transaction/material/"+trans_id;
          $("#declineroute").attr("action", declineroutes);


      $.get('/member/transaction/material/'+trans_id+'/edit', function (data) {
        console.log(data);
...
<?php echo $__env->make('layouts.member', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Art march 15 remake v3.51-uPDATED-latest\resources\views/pages\member\transaction\order.blade.php ENDPATH**/ ?>