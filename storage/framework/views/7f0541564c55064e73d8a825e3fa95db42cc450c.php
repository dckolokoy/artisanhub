                       ...
                       <div class="modal-dialog " role="document">
                         <div class="modal-content">
                           <div class="modal-header">
                             <h5 class="modal-title" id="exampleModalScrollableTitle">Admin Information</h5>
                             ...
                             <form action="/admin/admin" method="POST" enctype="multipart/form-data">
                               ...
                               <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="mobile" id="mobile" maxlength="11" placeholder="Mobile" required>
                                    </div>
                                </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                          ...
                          <button type="button" data-id="<?php echo e($user->id); ?>" class="btn btn-primary editbtn"> <i class="fas fa-edit"></i> </button>
                          ...
                          <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                  <div class="modal-header">
                                      <h5 class="modal-title" id="exampleModalLabel"> Update Admin Account Information </h5>
...
unset($__errorArgs, $__bag); ?>" name="mobile" value="<?php echo e(old('mobile')); ?>" minlength="11"  maxlength="11" required autocomplete="mobile" autofocus>     </div>
                     ...
                     <button type="button" class="btn btn btn-danger" onclick="confirmDelete('<?php echo e(route('admins.destroy', $user->id)); ?>')" 
                     color: inherit;
                          border: none;
                          padding: 0;
                          font: inherit;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\artisanhub\resources\views/pages\admin\admin\index.blade.php ENDPATH**/ ?>