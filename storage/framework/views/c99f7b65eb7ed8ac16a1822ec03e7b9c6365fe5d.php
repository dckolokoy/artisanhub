                ...
                <table class="table table-head-fixed text-nowrap table-striped table-hover center-div" id="myTable" >
                  ...
                  <tbody>
                    ...
                    <td class="align-middle">
                          ...
                          <?php if($transaction ->t_status == 8): ?>
                            <form action="/updateorder/<?php echo e($transaction ->t_id); ?>" method="POST" enctype="multipart/form-data" style="display: inline;">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('justnpot.customer-main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Art march 15 remake v3.51-uPDATED-latest\resources\views/justnpot/customer/transactions.blade.php ENDPATH**/ ?>