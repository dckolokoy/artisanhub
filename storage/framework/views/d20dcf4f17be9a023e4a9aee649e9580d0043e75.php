...
<header class="top-navbar" >
    <nav class="navbar navbar-expand-lg navbar-light nav-fixed">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(route('index')); ?>">
                <img src="<?php echo e(asset('justnpot/images/menu/main4.png')); ?>" alt="" style="width:100px;height:100px"/>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbars-rs-food">
                <ul class="navbar-nav ml-auto">
                    ...
                    <!-- <li class="nav-item"><a class="nav-link" href="<?php echo e(route('career')); ?>">Careers</a></li> -->
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('customer-about')); ?>">About Us</a></li>
                  
                    </li>
                    <?php if(Auth::check()): ?>
    <?php if(Request::route()->getName() == 'single.show'): ?>
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="dropdown-b" data-toggle="dropdown"><?php echo e(Auth::user()->name); ?></a>
    ...
    <?php else: ?>
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown"><?php echo e(Auth::user()->name); ?></a>
    ...
    <?php endif; ?>
    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('my-carts')); ?>">Cart</a></li>
    <li class="nav-item">
        <div id="side-menu">
            <?php echo $__env->make('pages.admin.notification.customer-alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </li>
<?php else: ?>
...
<script>
    ...
    var url = "<?php echo e(route('chat', ['material_id' => ':material_id', 'store_id' => ':store_id'])); ?>";
    ...
    $.post('<?php echo e(route('chat.mark-as-read')); ?>', {
        store_id: StoreId,
...
<?php /**PATH C:\xampp\htdocs\Art march 15 remake v3.51-uPDATED-latest\resources\views/justnpot/layout/header.blade.php ENDPATH**/ ?>