...
unset($__errorArgs, $__bag); ?>" aria-label="Default select example" name="type" id="type" required value="<?php echo e(old('type')); ?>" required autocomplete="type" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="mobile" value="<?php echo e(old('mobile')); ?>"  minlength="11" maxlength="11" required autocomplete="mobile" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="age" value="<?php echo e(old('age')); ?>" required autocomplete="age" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="birthdate" value="<?php echo e(old('birthdate')); ?>" required autocomplete="birthdate" autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end"><?php echo e(__('ID Image')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Profile Picture ')); ?></label>
...
<?php echo $__env->make('justnpot.customer-main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\artisanhub\resources\views/auth/register.blade.php ENDPATH**/ ?>