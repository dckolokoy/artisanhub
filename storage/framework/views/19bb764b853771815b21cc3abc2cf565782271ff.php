            ...
            <div class="container-fluid">
                <div class="row p-5">
                    ...
                    <div class="mx-auto col-md-8 col-lg-5 order-lg-last d-flex justify-content-center" >
                        <img id="carousel_img_height" class="img-fluid second" src="<?php echo e(asset('/justnpot/images/menu/main3.jpeg')); ?>" alt="">
                    </div>
                    <div class="col-lg-6 mb-0 d-flex align-items-center">
                        <div class="text-align-left align-self-center" id="context">
                            <h1 class="h1" style="color:black;">ArtisanHub </h1>
                            <h3 class="h2">E-commerce web system for Graphic Artists.
                            </h3>
                            <p>
...
<div class="top-content">
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                ...
                <div class="row">
                    ...
                    <?php $__currentLoopData = $data['menu2']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4">
                        ...
                        ?>
                                <div id="<?php echo e($menu2->m_id); ?>" class="carousel slide" data-ride="carousel">
                            
  <div class="carousel-inner">
    <div class="carousel-item active">
    <img class="card-img-top rounded-0 img-fluid" style="  width:  100%;
                                    height: 400px;"
                                    src="<?php echo e(asset(''.$menu2->image.'')); ?>">
                                    <div id="watermark" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%) rotate(-45deg); color: purple  ; opacity: .5; font-size: 28px !important; font-weight: bold; text-shadow: 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7); display: inline-block; width: 100%; text-align: center;"><?php echo e($menu2->artist); ?> </div>
                                    ...
                                    <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-left justify-content-left">
                                        <ul class="list-unstyled">
                                            ...
                                            <?php if(Auth::check()): ?>
                                                    ...
                                                    ->where('likes.menu_item_id',$menu2
                                                    ->m_id)
                                ...
                                $total_likes = $like_count ?? 0;
                                                        ?>
                                                    <?php if($liked == 1): ?>
                                                        <a class="btn  text-white unlikeBtn" data-id="<?php echo e($menu2
                                                    ...
                                                    <?php else: ?>
                                                        <a class="btn  btn-success text-white likeBtn" style=" width: 51px;"  data-id="<?php echo e($menu2
                                    ...
                                    ?>
                                        ...
                                        <li><a class="btn btn-success text-white mt-2" href="/single/<?php echo e($menu2
                                            ->m_id); ?>"><i class="far fa-eye"></i></a>
                                        ...
                                        <li>
                                           ...
                                           ->where('transaction_items.menu_item_id',$menu2
                                           ->m_id)
                                           ...
                                           ->get();
                                            ...
                                            <?php if(Auth::check()): ?>
                                                  ...
                                                  <a  href="<?php echo e(route('chat', ['material_id' => $menu2
                                                    ->m_id, 'store_id' => $menu2
                                                    ->s_id])); ?>"  class="btn btn-success text-white mt-2 "><i class="far fa-comment-dots"></i></a>
  ...
  <?php endif; ?>
  <a class="carousel-control-prev" href="#<?php echo e($menu2->m_id); ?>" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" href="#<?php echo e($menu2->m_id); ?>" role="button" data-slide="next">
...
<img class="card-img rounded-0 mt-4  img-fluid" style="  width:  100%;
             ...
             <?php endif; ?>                   </div>
                                <div class="card-body">
                                    <center>
                                        <span href="shop-single.html" class="h3 text-decoration-none"><?php echo e($menu2->m_name); ?></span>
                                        <br>
                                        <span style="font-size:15px !important;">Artist:  <strong><?php echo e($menu2->artist); ?></strong></span>
                                        <br>
                                        <span style="font-size:15px !important;">Category:  <strong><?php echo e($menu2->c_name); ?></strong></span>
                                    </center>
                                    ...
                                    <p class="text-center mb-0">₱ <?php echo e(number_format($menu2->price)); ?></p>
                                    ...
                                    <?php if(Auth::check()): ?>
                                        ...
                                        <?php else: ?>
                                         <ul class="list-unstyled d-flex justify-content-center mb-1">
                                         <div class=" text-white rounded" style="padding-right: 20px;padding-left:20px;6">
                                              <br>
                                                    </div>
                                        </ul> 
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 product-wap rounded-0">
                                <div class="card rounded-0">
                                    ...
                                    height: 300px;
                                    object-fit: cover;"
                                    src="<?php echo e(asset(''.$menu3->image.'')); ?>">
                                    <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-left justify-content-left">
                                        <ul class="list-unstyled">
                                            <li>
                                                <?php
                                               ...
                                               ->get();
                                                ...
                                                ?>
                                                <?php if($liked == 1): ?>
                                                    <a class="btn  text-white unlikeBtn" data-id="<?php echo e($menu3->m_id); ?>" style="background-color: red" href="shop-single.html">
                                                        <i class="far fa-heart"></i>
                                                     </a>
                                                <?php else: ?>
                                                    <a class="btn btn-success text-white likeBtn" data-id="<?php echo e($menu3->m_id); ?>" href="shop-single.html">
                                                        <i class="far fa-heart"></i>
                                                    </a>
                                                <?php endif; ?>
                                            ...
                                            <li><a class="btn btn-success text-white mt-2" href="/single/<?php echo e($menu3->m_id); ?>"><i class="far fa-eye"></i></a>
                                            ...
                                            <li>
                                               ...
                                               ->get();
                                                ...
                                                <?php if(Auth::check()): ?>
                                                      <a  data-id="<?php echo e($menu3->m_id); ?>" class="btn btn-success text-white mt-2 editbtn"><i class="fas fa-cart-plus"></i></a>
                                                      <br>
                                                      <a  href="<?php echo e(route('chat', ['material_id' => $menu3->m_id, 'store_id' => $menu3->store_id])); ?>"  class="btn btn-success text-white mt-2 "><i class="far fa-comment-dots"></i></a>
                                                      <?php else: ?>
                                                      <a  href="<?php echo e(route('login')); ?>" class="btn btn-success text-white mt-2 "><i class="fas fa-cart-plus"></i></a>
                                                <?php endif; ?>
                                ...
                                <div class="card-body">
                                    <center>
                                        <span href="shop-single.html" class="h3 text-decoration-none"><?php echo e($menu3->m_name); ?></span>
                                        <br>
                                        <span style="font-size:15px !important;">Artist:  <strong><?php echo e($menu3->artist); ?></strong></span>
                                        <br>
                                        <span style="font-size:15px !important;">Category:  <strong><?php echo e($menu3->c_name); ?></strong></span>
                                    </center>
                                    <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    ...
                                    <p class="text-center mb-0">₱ <?php echo e(number_format($menu3->price)); ?></p>
                                    <?php if(Auth::check()): ?>
            ...
            <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                ...
                <div class="row">
                    ...
                    <?php $__currentLoopData = $data['menu4']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu4): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4">
                            <div class="card mb-4 product-wap rounded-0">
                                <div class="card rounded-0">
                        ...
                        ?>
                                <div id="ez<?php echo e($menu4->m_id); ?>" class="carousel slide" data-ride="carousel">
                           
  <div class="carousel-inner">
    <div class="carousel-item active">
    <img class="card-img rounded-0 img-fluid" style="  width:  100%;
                                  height: 400px;"
                                    src="<?php echo e(asset(''.$menu4->image.'')); ?>">
                                    <div id="watermark" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%) rotate(-45deg); color: purple  ; opacity: .5; font-size: 28px !important; font-weight: bold; text-shadow: 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7); display: inline-block; width: 100%; text-align: center;"><?php echo e($menu4->artist); ?> </div>
                                ...
                                $total_likes1 = $like_count ?? 0;
                                                        ...
                                                        ?>
                                                        <?php if($liked == 1): ?>
                                                            <a class="btn  text-white unlikeBtn" data-id="<?php echo e($menu4->m_id); ?>" style="background-color: red" href="shop-single.html">
                                                                <i class="far fa-heart"><span style="font-size: 15px !important;"><?php echo e($total_likes1); ?></span></i>
                                                            </a>
                                                        <?php else: ?>
                                                            <a class="btn  btn-success text-white likeBtn"  data-id="<?php echo e($menu4->m_id); ?>" href="shop-single.html">
                                                                <i class="far fa-heart"><span style="font-size: 15px !important;"><?php echo e($total_likes1); ?></span></i>
                                                            </a>
                                                        <?php endif; ?>
                                                <?php else: ?>
                                    ...
                                    ?>
                                            ...
                                            <li><a class="btn btn-success text-white mt-2" href="/single/<?php echo e($menu4->m_id); ?>"><i class="far fa-eye"></i></a>
                                            ...
                                            <li>
                                               ...
                                               ->get();
                                                ...
                                                <?php if(Auth::check()): ?>
                                                        ...
                                                        <a  data-id="<?php echo e($menu4->m_id); ?>" data-user="<?php echo e($owned); ?>" class="btn btn-success text-white mt-2 editbtn"><i class="fas fa-cart-plus"></i></a><br>
                                            
                                                    <?php else: ?>
                                                        <a  data-id="<?php echo e($menu4->m_id); ?>" data-user="<?php echo e($owned); ?>" class="btn btn-success text-white mt-2 editbtn"><i class="fas fa-cart-plus"></i></a><br>
                                                    <?php endif; ?>
                                                      <a  href="<?php echo e(route('chat', ['material_id' => $menu4->m_id, 'store_id' => $menu4->store_id])); ?>"  class="btn btn-success text-white mt-2 "><i class="far fa-comment-dots"></i></a>
  ...
  <a class="carousel-control-prev" href="#ez<?php echo e($menu4->m_id); ?>" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" href="#ez<?php echo e($menu4->m_id); ?>" role="button" data-slide="next">
    <span class="carousel-control-next-icon" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>  
<?php elseif($menu4->type!="tangible"): ?>
<img class="card-img rounded-0 mt-4 img-fluid" style="  width:  100%;
                                        height: 400px;"
                                    src="<?php echo e(asset(''.$menu4->image.'')); ?>">
                                    <div id="watermark" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%) rotate(-45deg); color: purple  ; opacity: .5; font-size: 28px !important; font-weight: bold; text-shadow: 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7), 0px 0px 10px rgba(255,255,255,0.7); display: inline-block; width: 100%; text-align: center;"><?php echo e($menu4->artist); ?> </div>
                                ...
                                <div class="card-body">
                                    <center>
                                        <span href="shop-single.html" class="h3 text-decoration-none"><?php echo e($menu4->m_name); ?></span>
                                        <br>
                                        <span style="font-size:15px !important;">Artist:  <strong><?php echo e($menu4->artist); ?></strong></span>
                                        <br>
                                        <span style="font-size:15px !important;">Category:  <strong><?php echo e($menu4->c_name); ?></strong></span>
                                    </center>
                                    <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    ...
                                    <p class="text-center mb-0">₱ <?php echo e(number_format($menu4->price)); ?></p>
                                    <?php if(Auth::check()): ?>
            ...
            ?>
                <div class="col-12 col-md-4 p-5 mt-3">
                  ...
                  style="  width: 100%;height: 300px; ">
                    ...
                    <h5 class="text-center mt-3 mb-3"><?php echo e($user2->name); ?></h5>
                    <center>
                        <p class="text-center">
                            <form action="/search-seller/<?php echo e($user2->id); ?>" method="GET">
...
<?php echo $__env->make('justnpot.customer-main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Art march 15 remake v3.51-uPDATED-latest\resources\views/justnpot/customer/index.blade.php ENDPATH**/ ?>