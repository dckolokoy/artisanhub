...
<nav class="main-header  navbar-expand navbar-white navbar-light " style="padding: 5px !important;z-index: 1">
  <!-- Left navbar links -->
     <div class="row mx-0">
          ...
          <div class="col-sm-5">
            <h4 style="font-weight: bold" class="mt-1">Manage Member</h4>
          </div>
                             ...
                             <form action="/admin/member" method="POST" enctype="multipart/form-data">
                               ...
                               <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="11" name="mobile" id="mobile" placeholder="Mobile" required>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>" name="mobile" value="<?php echo e(old('mobile')); ?>" minlength="11"  maxlength="11" required autocomplete="mobile" autofocus>      </div>
                     ...
                     <button type="button" class="btn btn  btn-danger" onclick="confirmDelete('<?php echo e(route('members.destroy', $user->id)); ?>')" color: inherit;
                          border: none;
                          padding: 0;
                          font: inherit;
                          cursor: pointer;
...
function confirmDelete(url) {
    if (confirm('Are you sure you want to delete this record? This will delete all the records including the artworks you uploaded')) {
  ...
  $(document).ready(function () {
    ...
    $('body').on('click', '.editbtn', function () {
      ...
      $('#editModal').modal('show');
         ...
         let updateroutes = "/admin/member/"+user_id;
          $("#updateroute").attr("action", updateroutes);


      $.get('/admin/member/'+user_id+'/edit', function (data) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\artisanhub\resources\views/pages\admin\member\index.blade.php ENDPATH**/ ?>